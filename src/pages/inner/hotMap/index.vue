		...
		<div id="hotmap_controller">
            ...
            <div class="hotmap_search">
                <el-row style='float:left;'>
                  <el-col :span="11" style='width:100px; margin-top:10px;'>
                    <el-input v-model="startDriving" placeholder="请输入起点"></el-input>
                  </el-col>
                  <el-col :span="2" style='width:10px; margin-top:10px;'>
                    <span style="font-weight:bolder; margin-left:2px; color:#444;">-</span>
                  </el-col>
                  <el-col :span="11" style='width:100px; margin-top:10px;'>
                ...
                <div class="hotmap_search_place">
                    <el-input v-model="endDriving" placeholder="输入详细地址"></el-input>
                </div>
...
#hotmap_controller .group-button {
    float: right;
    margin-top: 10px;
    margin-right: 25px;
}

#hotmap_controller .group-button button:nth-of-type(1) {
    width: 80px;
    height: 36px;
    background: #868686;
    border: none;
...
#hotmap_controller .group-button button:nth-of-type(2) {
    width: 80px;
    height: 36px;
    text-align: center;
    padding: 0;
...
#hotmap_controller .group-button button:nth-of-type(3) {
    width: 80px;
    height: 36px;
    text-align: center;
    padding: 0;
