...
<style scoped>
  div.countTitle{background:#48576a;padding:10px;color:#fff;margin-bottom:20px;}
  span.timePeried{margin-left:10px;}
  span.division{padding:0 2px;}
  button.query{float:right;}
  button.isClick{background:red;}
